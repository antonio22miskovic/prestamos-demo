<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Préstamos Activos</p>
                                <p class="text-2xl font-semibold text-gray-900 dark:text-gray-100">{{ $approvedLoans }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Total Desembolsado</p>
                                <p class="text-2xl font-semibold text-gray-900 dark:text-gray-100">${{ number_format($totalDisbursed, 2) }}</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">Solicitudes Recientes</h3>
                                    ...
                                    @foreach($recentApplications as $application)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                <a href="#" class="text-indigo-600 hover:text-indigo-900 dark:text-indigo-400 dark:hover:text-indigo-300">Ver detalles</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
                    ...
                    @else
                        <p class="text-gray-500 dark:text-gray-400">No hay solicitudes recientes.</p>
                    @endif
                </div>
            </div>
        </div>
