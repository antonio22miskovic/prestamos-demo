...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Líneas de validación del idioma
    |--------------------------------------------------------------------------
    |
    ...
    */
    ...
    | sea rápido especificar una línea de idioma personalizada específica para
    ...
    */
    ...
    | marcadores de posición de atributos con algo más amigable para el
    | desarrollador como "E-Mail Address" en lugar de "email". Esto simplemente
